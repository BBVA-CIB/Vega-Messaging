 ...
 */
public class MsgSecurityErrorRespTest
{
    ...
    public void testGettersSettersSerializeDeserialize() throws Exception
    {
        ...
        final MsgSecurityErrorResp readedMsgSecurity = new MsgSecurityErrorResp();
        ...
        Assert.assertEquals(msgSecurity.getErrorCode(), readedMsgSecurity.getErrorCode());
