...
{
    private static UUID OWN_INSTANCE_ID = UUID.randomUUID();
    private static UUID TARGET_INSTANCE_ID = UUID.randomUUID();
    ...
    private class Listener implements ISecurityRequestListener, ISecurityResponseListener
    {
