...
* resolver_daemon_address (deprecated - backward compatibility) -> Ip address where the unicast resolver daemon listen for client messages
* resolver_daemon_port (deprecated - backward compatibility) -> Port where the unicast resolver daemon listen for client messages
